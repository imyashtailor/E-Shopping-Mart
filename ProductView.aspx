<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite1.Master" AutoEventWireup="true" CodeBehind="ProductView.aspx.cs" Inherits="E_shopping_Website.ProductView" %>
                        ...
                        <asp:Repeater ID="rptrImage" runat="server">
                            <ItemTemplate>
                                <div class="item <%# GetActiveImgClass(Container.ItemIndex) %>">
                                    <img src="Images/ProductImages/inside images/<%# Eval("PID") %>/<%# Eval("Name") %><%# Eval("Extension") %>" alt="<%# Eval("Name") %>"  onerror="this.src='Images/ProductImages/inside images/nothing.jpg'"/>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
